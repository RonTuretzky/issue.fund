...
MergeBounty uses the [Decentral Park UI kit](https://github.com/decentralparknyc/decentralpark-ui-kit) at commit `7696b1b72460801ccc24abfa4e7d49c8abc72b9c`.
...
The npm package was unavailable when integrated. This is an explicitly scoped brand-asset integration, not a fork of the kit's component API or wallet providers. The upstream library remains unchanged. MergeBounty retains its local and browser wallet implementations and its own accessible dialogs.
