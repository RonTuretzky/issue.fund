...
[All documentation](../README.md) · [Read on the website](https://issue.fund/#docs/contributors/getting-started)
...
Next: [Prepare your pull request](https://issue.fund/#docs/contributors/prepare-pr).

- [Explore funded issues](https://issue.fund/#)
